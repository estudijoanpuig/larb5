@section('meta_keywords', 'vendes, editar, comptabilitat, gestió, clients, empresa')
@extends('layouts.app')

@section('title', 'Editar Venda')
@section('meta_description', 'Edita una venda existent, actualitza detalls i gestiona vendes a la comptabilitat de l\'empresa.')
