@section('meta_keywords', 'css, creative design, eines, desenvolupament, recursos, web')
@extends('layouts.app')

@section('title', 'Css essencials per Creative Design')
@section('meta_description', 'Recull de CSS essencials per a projectes de Creative Design. Exemples i bones pràctiques.')
...
<section id="features" class="features section">
    <div class="container">
        ...
        <div class="filter-buttons" style="display: flex; justify-content: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 0.5rem;">
            ...
            <button class="filter-btn" data-filter="tailwind">Tailwind</button>
            <button class="filter-btn" data-filter="uikit">UIkit</button>
            <button class="filter-btn" data-filter="css">CSS</button>
        </div>
        
        <div class="features-grid" id="features-grid">
            @php
                // Consulta modificada per obtenir totes les 17 sense filtrar per etiquetes específiques
